...
//    private View.OnClickListener mMissingThemes = new View.OnClickListener() {
//        @Override
//        public void onClick(View v) {
//            View v1 =v.findViewById(R.id.missing_theme_overlay);
//            v1.setVisibility(View.VISIBLE);
//            Iterator<String> it = uninstalled_themes.iterator();
//            while(it.hasNext()) {
//                TextView tv = (TextView) v.findViewById(R.id.missing_theme_names);
//                tv.setText(it.next());
//                tv.setVisibility(View.VISIBLE);
//            }
//        }
