...
public class SaveThemeDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = View.inflate(ctx, org.cyanogenmod.theme.chooser2.R.layout.fragment_save_theme, null);
        ...
        mSaveProgress = (ProgressBar) v.findViewById(org.cyanogenmod.theme.chooser2.R.id.save_progress_indicator);
        alert.setView(v)
                .setPositiveButton(org.cyanogenmod.theme.chooser2.R.string.dialog_save_theme_save_button_text, null)
                .setNegativeButton(org.cyanogenmod.theme.chooser2.R.string.dialog_save_theme_cancel_button_text,
