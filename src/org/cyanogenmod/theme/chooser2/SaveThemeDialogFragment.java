...
public class SaveThemeDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mWarningText = (TextView) v.findViewById(R.id.warning_text);
        ...
        alert.setView(v)
                .setPositiveButton
                        (R.string.dialog_save_theme_save_button_text,
                                null)
                .setNegativeButton
                      (R.string.dialog_save_theme_cancel_button_text,
    ...
    public void onStart() {
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Cursor cursor = resolver.query(ThemesContract.ThemeMixColumns.CONTENT_URI,null,
                ...
                if(cursor.getCount() >= 1) {
                    ...
                    ((ChooserActivity) getActivity()).setAppliedBaseTheme
                            (mThemeName.getText().toString());
        ...
        protected Integer doInBackground(Object... params) {
            ...
            if (themeMixUri != null) {
                try {
                    ...
                    if (id >= 0) {
                        final String[] projection = {ThemesContract.ThemesColumns._ID,
                                ThemesContract.ThemesColumns.TITLE};
                        ...
                        for (Map.Entry<String, String> entry : theme.entrySet()) {
                            ...
                            if (c != null) {
                                if (c.moveToFirst()) {
                                    ...
                                    mixEntryValues[idx].put(THEME_ID, c.getString(0));
                                    mixEntryValues[idx].put(THEME_NAME, c.getString(1));
