...
public class ChooserActivity extends FragmentActivity
    ...
    private static boolean is_change_frag = false;
...
//                mPager.setAdapter(mAdapter);
    ...
    public void setmAppliedBaseTheme(String value) {
...
//            }
    ...
    public void restartLoaderFromSaveThemeDialog() {
        startLoader(LOADER_ID_INSTALLED_THEMES);
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        if(is_change_frag) {
            PreferenceUtils.setAppliedBaseTheme(this,mAppliedBaseTheme);
            String applied_theme = PreferenceUtils.getAppliedBaseTheme(this);
            int size = mAdapter.mFragments.size();
            //mAdapter.mFragments.clear();
            size = mAdapter.mFragments.size();
            startLoader(LOADER_ID_INSTALLED_THEMES);
            //is_change_frag = false;
        }
