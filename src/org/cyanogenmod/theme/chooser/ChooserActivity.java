...
//                                wallpaperCmpntId = mCurrentWallpaperCmpntId;
        ...
        private void orderThemes() {
            ...
            // First add installed themes
            int N = mInstalledThemes.size();
            for (int i = 0; i < N; i++) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (!added) {
                    if (themeItemInfo.packageName.equals(mAppliedBaseTheme)) {
                        ...
                        appliedThemeIndex++;
//                    mOrderedThemes.add(appliedThemeIndex,themeItemInfo);
                    }
                    //mOrderedThemes.add(appliedThemeIndex + (i+1), themeItemInfo);
                    if (appliedThemeIndex == 0) {
                    ...
                    mOrderedThemes.add(mOrderedThemes.size()-1,themeItemInfo);
                }
            }
//            N = mThemeMixes.size();
//            for (int i = 0; i < N; i++) {
//                ThemeItemInfo themeItemInfo = mThemeMixes.get(i);
//                mOrderedThemes.add(appliedThemeIndex + 1, themeItemInfo);
//            }
        }
